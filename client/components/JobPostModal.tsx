...
export default function JobPostModal({ onClose, onJobPosted }: JobPostModalProps) {
        ...
        try {
            const res = await fetch("/api/jobs/create", {
                ...
                body: JSON.stringify({
                    ...
                    salaryRange,  // ← sending the built string not raw form
                }),
            })
            ...
            <div className=" relative z-10 w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl border border-zinc-800 bg-zinc-950 shadow-2xl">
                ...
                <div className="sticky top-0 z-10 flex items-center justify-between border-b border-zinc-800 bg-zinc-950 px-6 py-4">
                    <div className="flex items-center gap-3">
                        <div className="h-9 w-9 rounded-lg bg-indigo-600/20 flex items-center justify-center ring-1 ring-purple-500/20">
                ...
                <div className="p-6 space-y-5">
                    {submitted ? (
                        <div className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-green-500/30 bg-green-500/10 py-12 text-center">
                            ...
                            <p className="text-xl font-bold text-white">Job Posted!</p>
                            <p className="text-sm text-zinc-400">Your job is now live and visible to freshers.</p>
                            <button
                                onClick={onClose}
                        ...
                        <>
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="cursor-pointer w-full rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 py-3 text-sm font-semibold text-white transition-all hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                {loading ? (
                                   ...
                                   <p className="flex items-center justify-center gap-2"> Post Job <ArrowUpSquareIcon size={14}/></p>
                                )}
                            </button>
                        </>
                    )}
